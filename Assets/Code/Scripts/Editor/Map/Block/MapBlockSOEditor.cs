...
{
    [CustomEditor(typeof(MapBlockSO))]
    public class MapBlockSOEditor : Editor
    {
        private MapBlockSO block;
        private bool[,] grid;
        ...
        public override void OnInspectorGUI()
        {
            ...
            block.location = (BlockLocation)EditorGUILayout.EnumPopup("Location", block.location);

            switch (block.location)
            {
                case BlockLocation.Bottom:
                    block.upside = EditorGUILayout.ObjectField("Upside Type", block.upside, typeof(BlockMatchTypeSO), false) as BlockMatchTypeSO;
                    block.downside = null;
                    break;

                case BlockLocation.Middle:
                    block.upside = EditorGUILayout.ObjectField("Upside Type", block.upside, typeof(BlockMatchTypeSO), false) as BlockMatchTypeSO;
                    block.downside = EditorGUILayout.ObjectField("Downside Type", block.downside, typeof(BlockMatchTypeSO), false) as BlockMatchTypeSO;
                    break;

                case BlockLocation.Top:
                    block.upside = null;
                    block.downside = EditorGUILayout.ObjectField("Upside Type", block.downside, typeof(BlockMatchTypeSO), false) as BlockMatchTypeSO;
                    break;
            }
